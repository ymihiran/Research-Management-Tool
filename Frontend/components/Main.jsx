...
export default function Main(){
  ...
  else if((JSON.parse(localStorage.getItem('user')|| "[]")).user_role=="Student"){
    return (
  ...
  else if((JSON.parse(localStorage.getItem('user')|| "[]")).user_role=="Admin"){
    return (
      <div className="main-m-container">
        <div className="main-item-con">
        ...
        <div style={{backgroundColor:"white",boxShadow:"rgba(0, 0, 0, 0.24) 0px 3px 8px"}}>
          ...
          <div className="main-side-container">
            <div className="main-side-sub-container">
              <center>
                  <label className="main-t-lbl"> <label style={{color:"#FF5631"}}>Admin</label>  Links</label>
                </center>  
                <center>
                <a href='/allprof'> <button className="btn l-btn-accepted main-side-button">User Management</button></a> <br/>
                <a href='/StudentGroup'> <button className="btn l-btn-accepted main-side-button">Create Groups</button></a> <br/>
                <a href='/AllTypes'><button className="btn l-btn-accepted main-side-button">Submission Types</button></a> <br/>
                <a href='/AddMarking'><button className="btn l-btn-accepted main-side-button">Create Marking</button></a> <br/>
                <a href='/MarkingList'><button className="btn l-btn-accepted main-side-button">Marking List</button></a>
                <a href='/UploadTemplate'><button className="btn l-btn-accepted main-side-button">Templates</button></a>
          ...
          <MDBAccordion flush initialActive={1}>
      <MDBAccordionItem collapseId={1} headerTitle='Manage users in system'>
      You are responsible to manage all users in the system. You can add, edit, delete users. You can view a complete list of users. All users have a name, phone number, email address, and a role etc.
      Roles are different from each users. Be careful with user roles. 
      <br/>
      <br/>
      <a href='/allprof'><button className="btn btn-primary">All Profiles</button></a>
      </MDBAccordionItem>
      <MDBAccordionItem collapseId={2} headerTitle='Marking Schemes'>
        Admins should create marking schemes for evaluations. Marking schemes are different from each research topic. You can create marking schemes, edit marking schemes, and delete marking schemes.
        You can get a pdf from the edit view of the marking scheme.
        <br/>
        <br/>
        <a href='/AddMarking'><button className="btn btn-primary">Create Marking Scheme</button></a> 
        <a href='/MarkingList'><button style={{marginLeft:"10px"}} className="btn btn-primary">All Marking Schemes</button></a>
      </MDBAccordionItem>
      <MDBAccordionItem collapseId={3} headerTitle='Document Submission'>
        Admins can upload document templates for the research topics. Document templates are different from each research topic. You can upload document templates, edit document templates, and delete document templates.
        <br/>
        <br/>
        <a href='/UploadTemplate'><button className="btn btn-primary">New Template</button></a> 
        <a href='/SubmitDocs'><button style={{marginLeft:"10px"}} className="btn btn-primary">Upload Document</button></a>
      </MDBAccordionItem>
    </MDBAccordion>
  ...
  else if((JSON.parse(localStorage.getItem('user')|| "[]")).user_role=="Supervisor" || (JSON.parse(localStorage.getItem('user')|| "[]")).user_role=="Co-Supervisor"){
    return (
      <div className="main-m-container">
        <div className="main-item-con">
        ...
        <div style={{backgroundColor:"white",boxShadow:"rgba(0, 0, 0, 0.24) 0px 3px 8px"}}>
          ...
          <div className="main-side-container">
            <div className="main-side-sub-container">
              <center>
                  <label className="main-t-lbl"> <label style={{color:"#FF5631"}}>Supervisor</label>  Links</label>
                </center>  
                <center>
                <a href='/AcceptTopic'> <button className="btn l-btn-accepted main-side-button">Topic Review</button></a> <br/>
                <a href='/allDoc'> <button className="btn l-btn-accepted main-side-button">Evaluate Documents</button></a> <br/>
                <a href='/chat'><button className="btn l-btn-accepted main-side-button">Go to Chat</button></a> <br/>
                <a href='/profile'><button className="btn l-btn-accepted main-side-button2">My profile</button></a>
  ...
  else if((JSON.parse(localStorage.getItem('user')|| "[]")).user_role=="Panel Member" ){
    return (
      <div className="main-m-container">
        <div className="main-item-con">
        ...
        <div style={{backgroundColor:"white",boxShadow:"rgba(0, 0, 0, 0.24) 0px 3px 8px"}}>
          ...
          <div className="main-side-container">
            <div className="main-side-sub-container">
              <center>
                  <label className="main-t-lbl"> <label style={{color:"#FF5631"}}>Panel</label>  Links</label>
                </center>  
                <center>
                <a href='/allDoc'> <button className="btn l-btn-accepted main-side-button">Evaluate Topic</button></a> <br/>
                <a href='/allDoc'> <button className="btn l-btn-accepted main-side-button">Evaluate presentation</button></a> <br/>
