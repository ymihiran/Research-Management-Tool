        ...
        return(
            ...
            <div style={{backgroundColor:"white"}}>
                ...
                <div className="t-list-head-container">
                    <label className="h-text" style={{color:"#FF5631"}}> CREATE</label> <br className="br1" />
                ...
                <div className="t-list-tb-container">
                        ...
                        <div className="mb-3">
                            <label className="t-form-label"><b>Submission Type Name:</b></label>
                        ...
                        <button type="submit" className="btn btn-primary" style={{backgroundColor:"#0F0934",width:"200px",fontWeight:"bold"}} >CREATE</button>
